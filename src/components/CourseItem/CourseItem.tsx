...
import { Course, EBook } from "../../types/Course";
  ...
  return (
    ...
    >
      ...
      <VStack p={6}>
        ...
        <Text mt={10}>
          {levelLabelMapper[course.level as keyof typeof levelLabelMapper]}
          {course.topics?.length ? ` - ${course.topics?.length} ${_.startCase(LL.ui.lessons())}`: ""}
        </Text>
      </VStack>
    </Pressable>
  );
